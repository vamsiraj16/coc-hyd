    ...
    <footer className="bg-gray-100 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Church of Christ</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/sermons" className="text-gray-600 hover:text-blue-600">Sermons</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/ministries" className="text-gray-600 hover:text-blue-600">Ministries</Link></li>
              <li><Link to="/contact" className="text-gray-600 hover:text-blue-600">Contact</Link></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600">Prayer Requests</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600">Volunteer</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600">Give Online</a></li>
            </ul>
          </div>
